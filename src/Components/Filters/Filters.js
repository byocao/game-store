...
const Filters = (props) => {
  const { hoverState, handleHover, handleSelect, currentFilter } = props;
      ...
      <div className={styles.genreFilters}>
        ...
        >
          <button
            ...
            style={{
              backgroundColor:
                hoverState[11].hovered || currentFilter == 'Action'
                  ? '#fff'
                  : '#2d2d2d',
            }}
        ...
        >
          <button
            ...
            style={{
              backgroundColor:
                hoverState[13].hovered || currentFilter == 'RPG'
                  ? '#fff'
                  : '#2d2d2d',
            }}
        ...
        >
          <button
            ...
            style={{
              backgroundColor:
                hoverState[15].hovered || currentFilter == 'Adventure'
                  ? '#fff'
                  : '#2d2d2d',
            }}
        ...
        >
          <button
            ...
            style={{
              backgroundColor:
                hoverState[17].hovered || currentFilter == 'Racing'
                  ? '#fff'
                  : '#2d2d2d',
            }}
        ...
        >
          <button
            ...
            style={{
              backgroundColor:
                hoverState[18].hovered || currentFilter == 'Sports'
                  ? '#fff'
                  : '#2d2d2d',
            }}
